...
<section class="col-xs-12 main" style="display: flow-root;">
   <ul class="slider" tabindex="-1">
    <li>
      ...
      <img class="MainAcces" alt="데크가 이어진 길에 보이는 데크 사이트" src="/gaia/images/deck04.png">
        <dl class="right">
          <dt>간직하며 가고 싶은</dt>
          <dd>나만 알고싶은 , 그런 캠핑장</dd>
        </dl>
      </div>
    </li>
    <li>
      <div style="background-position: center;">
		<img class="MainAcces" alt="맑은 하늘과 푸른 산을 배경으로 보이는 편의시설" src="/gaia/images/MainDec01.jpg">
        <dl>
          <dt>그림같이 펼쳐지는</dt>
          <dd>아름다운 풍경을, 담아두는</dd>
        </dl>
    ...
    <li>
      <div style="background-position: center;">
        <img class="MainAcces" alt="산을 배경으로한 육각 정자가보이는 데크사이트 모습" src="/gaia/images/MainDec02.jpg">
        <dl class="right">
          <dt>지친 당신을 위한</dt>
          <dd>가족과 함께 힐링하고, 여유를 만끽하세요.</dd>
        </dl>
      </div>
    </li>
    <li>
      <div style="background-position: center;">
       <img class="MainAcces" alt="물이 굽이치는 계곡의 모습" src="/gaia/images/MainDec03.jpg"> 
        <dl>
          <dt>때뭍지 않은 순수한</dt>
          <dd>자연이 가득한 , 청결하고 변함없는</dd>
        </dl>
      </div>
    </li>
    <li>
      <div style="background-position: center;">
       <img class="MainAcces" alt="목제다리가 보이는 계단식으로 흐르는 계곡 풍경" src="/gaia/images/Main01.png">
        <dl class="right">
          <dt>굽이굽이 흐르는 물따라</dt>
          <dd>숲과 하늘이 맞닿은 곳, 하염없이 떠다니는 구름</dd>
        </dl>
      </div>
    </li>
    <li>
    ...
    <div style="text-align: center; position: relative; bottom: 180px;">
            ...
            <div class="modal-dialog	 modal-80size modal-lg  modal-center" style="width: 90%;margin: auto; padding-top: 30px; padding-bottom: 30px; padding-left: 10%;">
                <div class="modal-content  modal-80size" style="width: 90%;box-sizing: content-box;">
                    <div  style="display: inline-block; text-align: center; padding-top: 2%; font-size: 20px;">
                        <h3 class="modal-title">데크 사이트</h3>
                          <hr style="width: 90%;"/>
                    </div>
		...
		<div class="carousel-inner">
			<div class="carousel-item active" title="데크">
				<img src="<%= proBean.getP_IMG()%>" class="d-block w-100" alt="데크 사이트">
